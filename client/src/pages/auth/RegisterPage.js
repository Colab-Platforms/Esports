      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-3">
            <ProviderLoginButton provider="google" mode="login" label="Sign up with Google" />
            <ProviderLoginButton provider="facebook" mode="login" label="Sign up with Facebook" />
            <ProviderLoginButton provider="steam" mode="login" label="Sign up with Steam" />
            <ProviderLoginButton provider="xbox" mode="login" label="Sign up with Xbox" />
          </div>
