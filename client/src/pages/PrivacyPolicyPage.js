...
const SubHeading = ({ children }) => (
  <h3 className="text-lg font-semibold text-gaming-neon mt-6 mb-2">{children}</h3>
);
    ...
    <div className="min-h-screen bg-gaming-dark py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-gaming font-bold text-white mb-2">
          Privacy Policy for Colab Esports
        </h1>
        <p className="text-gray-500 mb-10">Last updated: September 01, 2026</p>
        ...
        <Section>
          ...
          <p>
            ...
            We have a valid legal basis to do so, including Your consent (where consent is required).
          </p>
        </Section>
        ...
        <Section title="Interpretation and Definitions">
          ...
          <ul className="list-disc list-inside space-y-2 pl-2">
            ...
            <li><strong className="text-white">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Colab Esports, 202, Takshashila Building Samant Estate, Behind Sai Veg World, Near Goregaon Station, Goregaon (East).</li>
            ...
            <li><strong className="text-white">Country/State</strong> refers to: Maharashtra, India.</li>
            ...
            <li><strong className="text-white">User</strong> means any individual who accesses or uses the Service.</li>
            <li><strong className="text-white">Website</strong> refers to Colab Esports, accessible from <a href="https://www.colabesports.in/" className="text-gaming-neon hover:underline">https://www.colabesports.in/</a>.</li>
            <li><strong className="text-white">You</strong> mean the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          </ul>
        </Section>

        <Section title="Collecting and Using Your Personal Information">
          ...
          <ul className="list-disc list-inside space-y-2 pl-2">
            <li>
              <strong className="text-white">Cookies or Browser Cookies.</strong> A cookie is a small file
              placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a
              Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some
              parts of Our Service.
            </li>
            <li>
              <strong className="text-white">Web Beacons.</strong> Certain sections of Our Service may contain
              ...
              pages and for other related website statistics (for example, recording the popularity of a
          ...
          <p>
            Where required by law, we use non-essential cookies (that is, Cookies other than the Necessary /
            Essential Cookies described below) only with Your consent. You can withdraw or change Your consent
            at any time using Our cookie preferences tool (if available) or through Your browser/device
            settings. Withdrawing consent does not affect the lawfulness of processing based on consent before
            its withdrawal.
          </p>
          ...
          <ul className="list-disc list-inside space-y-3 pl-2">
            ...
            <li>
              ...
              and record the consent choices You have made, so that We can honor those choices on future
              visits.
            </li>
            <li>
              ...
              remembering Your Account login details or language preference. The purpose of these Cookies is
        ...
        <Section title="Use of Your Personal Data">
          ...
          <ul className="list-disc list-inside space-y-2 pl-2">
            ...
            <li><strong className="text-white">To provide You with news, special offers, and general information</strong> about other goods, services and events which We offer that are similar to those that You have already purchased or inquired about. We send such marketing communications only where permitted by applicable law: where prior consent is required (for example, under the laws applicable in the EEA and the UK), We will send them only with Your consent; otherwise, we may send them until You opt out. You may opt out or withdraw Your consent at any time by using the unsubscribe link in any marketing email We send or by contacting Us.</li>
            <li><strong className="text-white">To manage Your requests:</strong> To attend and manage Your requests to Us.</li>
            <li><strong className="text-white">For business transfers:</strong> We may use Your Personal Data to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about Our Service users is among the assets transferred.</li>
            <li><strong className="text-white">For other purposes:</strong> We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of Our promotional campaigns, and evaluating and improving Our Service, products, services, marketing and Your experience.</li>
          </ul>

          <p className="mt-4">We may share Your Personal Data in the following situations:</p>
          <ul className="list-disc list-inside space-y-2 pl-2">
            <li><strong className="text-white">With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyse the use of Our Service, and to contact You.</li>
            <li><strong className="text-white">For business transfers:</strong> We may share or transfer Your Personal Data in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
            <li><strong className="text-white">With Affiliates:</strong> We may share Your Personal Data with Our affiliates, in which case We will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
            <li><strong className="text-white">With other users:</strong> If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside the Service.</li>
        ...
        <Section title="Text Messages Privacy Notice">
          <p>
            ...
            in, we will collect and store the information You provide in connection with text messaging, such
            as Your phone number, the date and method of Your consent, and message delivery and read
            information.
          </p>
          <p>
            No mobile information will be shared with or sold to third parties or affiliates for marketing or
            promotional purposes. The phone numbers and consent records We collect for texting are never
            shared with anyone for any purpose, except the Service Providers that technically have to handle
            them to deliver the texts.
          </p>
          <p>
            Consent to receive text messages is not a condition of any purchase or use of Our Service. If You
            consent to receive SMS from Us, you agree to receive text messages from Us related to:
          </p>
          <ul className="list-disc list-inside space-y-1 pl-2">
        ...
        <Section title="Retention of Your Personal Data">
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li><strong className="text-white">Legal obligation:</strong> We are required by law to retain specific data (e.g., financial records for tax authorities).</li>
            <li><strong className="text-white">Legal claims:</strong> Data is necessary to establish, exercise, or defend legal claims.</li>
            <li><strong className="text-white">Your explicit request:</strong> You ask Us to retain specific information.</li>
            <li><strong className="text-white">Technical limitations:</strong> Data exists in backup systems that are scheduled for routine deletion.</li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li><strong className="text-white">Deletion:</strong> Personal Data is removed from Our systems and no longer actively processed.</li>
            <li><strong className="text-white">Backup retention:</strong> Residual copies may remain in encrypted backups for a limited period consistent with Our backup retention schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.</li>
            <li><strong className="text-white">Anonymization:</strong> In some cases, we convert Personal Data into anonymous statistical data that cannot be linked back to You. This anonymized data may be retained indefinitely for research and analytics.</li>
          </ul>
        </Section>
        ...
        <Section title="Transfer of Your Personal Data">
          <p>
            ...
            any other places where the parties involved in the processing are located. This means that this
          ...
          <p>
            Where required by applicable law, we will ensure that international transfers of Your Personal
            Data are subject to appropriate safeguards and, where relevant, supplementary measures. The
            Company will take all steps reasonably necessary to ensure that Your data is treated securely and
        ...
        <Section title="Delete Your Personal Data">
          ...
          <p>
            ...
            information. You may also contact Us to request access to, correct, or delete any Personal Data
        ...
        <Section title="Children's and Minors' Privacy">
          <p>
            The Service is not directed to, and We do not knowingly collect Personal Information from, anyone
            under the age of 16.
          </p>
          <p>
            ...
            from anyone under the age of 16, We will take steps to remove that information from Our servers as
            soon as reasonably possible.
          </p>
          <p>
            Some countries and states set a higher age at which an individual can consent to the processing of
            their own Personal Information. Where We rely on consent as a legal basis and the law applicable to
            a User sets an age higher than 16, We may require the consent of that User's parent or guardian
        ...
        <Section title="Intellectual Property, Copyright and Brand Rights">
          <p>
            Unless otherwise stated, all content, materials, and intellectual property displayed, published, or
            otherwise made available through the Service are owned by or licensed to Colab Esports and are
            protected by applicable intellectual property and copyright laws.
          </p>
          <p>This includes, without limitation:</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>The Colab Esports name, logos, brand identity, trademarks, and associated brand elements;</li>
            <li>Any mascots, mascot designs, characters, character names, illustrations, and associated visual representations created for or used by Colab Esports;</li>
            <li>Website designs, layouts, graphics, user interface elements, artwork, and other creative assets;</li>
            <li>Original text, videos, photographs, promotional materials, social media content, and other digital content created or owned by Colab Esports; and</li>
            <li>Tournament names, event branding, campaign concepts, proprietary materials, and other original content associated with Colab Esports.</li>
          </ul>
          <p>
            All rights, title, and interest in such intellectual property are reserved by Colab Esports and/or
            the applicable rights holders. Nothing contained on the Service shall be construed as granting, by
            implication, estoppel, or otherwise, any licence or right to use any intellectual property
            belonging to Colab Esports without prior written permission.
          </p>
          <p>
            Except where expressly permitted in writing by Colab Esports or permitted by applicable law, no
            person may copy, reproduce, modify, adapt, publish, distribute, transmit, display, commercially
            exploit, or otherwise use any of the above-mentioned materials, in whole or in part.
          </p>
          <p>
            Unauthorized use, reproduction, imitation, or misuse of Colab Esports' intellectual property,
            including its mascot, branding, logos, designs, copyrighted content, or other proprietary
            materials, may result in appropriate action under applicable law.
          </p>
          <p>
            Certain third-party names, trademarks, game titles, logos, characters, images, and other
            intellectual property that may appear on the Service are the property of their respective owners.
            Their appearance on the Service does not, unless expressly stated, imply that Colab Esports owns,
            is affiliated with, sponsored by, endorsed by, or otherwise officially connected with those third
            parties.
          </p>
          <p className="text-white font-semibold">© 2026 Colab Esports. All Rights Reserved.</p>
        </Section>
        ...
        <Section title="Contact Us">
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>
              ...
              <a href="https://www.colabesports.in/privacy" className="text-gaming-neon hover:underline">
                https://www.colabesports.in/privacy
              </a>
            </li>
          </ul>
        </Section>
