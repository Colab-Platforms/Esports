...
const FreeFirePage = () => {
  ...
  useEffect(() => {
    // Fetch Free Fire tournaments based on active tab and debounced filters
  ...
  if (loading && isInitialLoad) {
    return (
      <div className="min-h-screen bg-gaming-dark flex items-center justify-center">
        <LoadingSpinner size="lg" text="Loading Free Fire tournaments..." />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gaming-dark">
      {/* Banner Slider */}
      <PageBannerSlider pageKey="freefire" height="h-96" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
          ...
          {!tournaments || tournaments.length === 0 ? (
            <div className="card-gaming p-8 text-center">
              ...
              <h2 className="text-xl font-bold text-white mb-2">No Free Fire Tournaments Found</h2>
